...
var noiseScale=0.02;
  ...
  for (var q=0; q < this.width; q++) 
	{
    var noiseVal = noise(q*noiseScale, m*noiseScale);
  }
  ...
  this.display = function() 
    ...
    stroke(0);
		fill(100,40,98);
    ellipse(q* 2, noiseVal*600,50,50);
		
		//blue
		strokeWeight(.2);
    stroke(0);
		fill(40,70,188);
    ellipse(q* 2, noiseVal*550,50, 50);
		
		//green
		strokeWeight(.2);
    stroke(0);
		fill(40,170,88);
    ellipse(q* 2, noiseVal*500,50,50);
		
		//yellow
		strokeWeight(.2);
    stroke(0);
		fill(244, 241, 66);
    ellipse(q* 2, noiseVal*450,50, 50);
		
		//orange
		strokeWeight(.2);
    stroke(0);
		fill(244, 163, 65);
    ellipse(q* 2, noiseVal*400,50, 50);
		
		//red
		strokeWeight(.2);
    stroke(0);
		fill(244, 67, 65);
    ellipse(q * 2, noiseVal*350,50, 50);
